...
To install dependencies and build the package, navigate to the raw-to-stage folder and run,
...
upload the built wheel file in `raw-to-stage/dist/dap-etl-0.1.0-none-any.whl` to s3://{raw}-dap-elt-metadata/txma/raw-to-stage
