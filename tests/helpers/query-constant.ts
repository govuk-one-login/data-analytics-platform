export const DIM_DATE_COLUMNS = 'SELECT\n' +
...
export const DIM_EVENT_COLUMNS = 'select event_name,product_family,event_description,event_journey_type, created_by,created_date,modified_by,batch_id from dap_txma_reporting_db.conformed.dim_event';

export const DIM_RELYING_PARTY_COLUMNS = 'select client_id, relying_party_name,relying_party_description ,created_by,created_date,modified_by,modified_date,batch_id,relying_party_key from dap_txma_reporting_db.conformed.dim_relying_party';

export const DIM_VERIFICATION_ROUTE = 'select verification_route_key, ' +
...
export const DIM_JOURNEY_CHANNEL = 'select journey_channel_key,channel_name,channel_description,created_by,created_date ,modified_by,modified_date,batch_id FROM dap_txma_reporting_db.conformed.dim_journey_channel';

export const FACT_USER_JOURNEY_EVENT = 'SELECT user_journey_event_key,event_key,date_key ' +
