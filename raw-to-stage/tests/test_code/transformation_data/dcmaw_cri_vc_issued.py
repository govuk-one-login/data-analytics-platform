...
def dcmaw_cri_vc_issued_input_output(timestamp, timestamp_formatted, timestamp_ms, processed_dt, processed_time):
    ...
    raw = {
        ...
        "extensions": {
            "evidence": {
                "activityHistoryScore": "serialise",
                "strengthScore": "1",
                "type": "asymmetric",
                "validityScore": "Road",
                "checkDetails": {
                    "biometricVerificationProcessLevel": "level",
                    "checkMethod": "method 1"
                },
                "failedCheckDetails": {
                    "biometricVerificationProcessLevel": "Account",
                    "checkMethod": "method 2"
                }
            },
        },
        "year": year,
