...
*/
        ...
        where Procedure_name='fact_user_journey_event_refactored_upsert'; 
            ...
            RAISE INFO 'fact_user_journey_event_refactored_upsert: Procedure completed successfully.';

        EXCEPTION WHEN OTHERS THEN
            RAISE EXCEPTION '[fact_user_journey_event_refactored_upsert] Error: %', SQLERRM;
