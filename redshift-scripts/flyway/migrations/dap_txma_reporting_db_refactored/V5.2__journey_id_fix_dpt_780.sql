...
USING "conformed_refactored"."dim_event_refactored" AS de
...
DELETE FROM "conformed_refactored"."dim_user_journey_event_refactored"
USING "dap_txma_stage"."txma_stage_layer" stg
