...
BEGIN
    ...
    SET 
      ...
      ,CHECK_DETAILS_KBV_RESPONSE_MODEL=json_serialize(st.CHECK_DETAILS_KBV_RESPONSE_MODEL)
      ,CHECK_DETAILS_KBV_QUALITY=json_serialize(st.CHECK_DETAILS_KBV_QUALITY)
