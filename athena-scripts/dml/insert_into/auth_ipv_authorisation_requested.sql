INSERT INTO "environment-txma-stage"."auth_orchestration" (
	...
	timestamp,
	timestamp_formatted,
	extensions_clientlandingpageurl,
	year,
	month,
	day,
	processed_date,
...
SELECT
	...
	case format('%s',cast("extensions"."clientLandingPageUrl" as VARCHAR))  
		when 'null' then null
	    else format('%s',cast("extensions"."clientLandingPageUrl" as VARCHAR))
...
FROM 
	"environment-txma-raw"."auth_ipv_authorisation_requested"
WHERE
