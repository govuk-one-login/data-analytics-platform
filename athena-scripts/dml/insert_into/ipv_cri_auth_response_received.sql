INSERT INTO "environment-txma-stage"."ipv_contra_indicator" (
	event_id,
	client_id,
	component_id,
...
SELECT
	...
	'' as extensions_errordescription,
...
FROM 
	"environment-txma-raw"."ipv_cri_auth_response_received"
WHERE
